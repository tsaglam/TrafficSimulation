...
std::vector<std::unique_ptr<Vehicle>>::const_iterator VehicleIterator::cbegin() {
  return domainModel.vehicles.cbegin();
}

std::vector<std::unique_ptr<Vehicle>>::const_iterator VehicleIterator::cend() {
  return domainModel.vehicles.cend();
}

std::vector<std::unique_ptr<Vehicle>>::iterator VehicleIterator::begin() {
  return domainModel.vehicles.begin();
}

std::vector<std::unique_ptr<Vehicle>>::iterator VehicleIterator::end() {
...
std::vector<std::unique_ptr<Street>>::const_iterator StreetIterator::cbegin() {
  return domainModel.streets.cbegin();
}

std::vector<std::unique_ptr<Street>>::const_iterator StreetIterator::cend() {
  return domainModel.streets.cend();
}

std::vector<std::unique_ptr<Street>>::iterator StreetIterator::begin() {
  return domainModel.streets.begin();
}

std::vector<std::unique_ptr<Street>>::iterator StreetIterator::end() {
...
std::vector<std::unique_ptr<Junction>>::const_iterator JunctionIterator::cbegin() {
  return domainModel.junctions.cbegin();
}

std::vector<std::unique_ptr<Junction>>::const_iterator JunctionIterator::cend() {
  return domainModel.junctions.cend();
}

std::vector<std::unique_ptr<Junction>>::iterator JunctionIterator::begin() {
  return domainModel.junctions.begin();
}

std::vector<std::unique_ptr<Junction>>::iterator JunctionIterator::end() {
